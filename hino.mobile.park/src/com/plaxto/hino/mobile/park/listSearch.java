...
import com.plaxto.hino.mobile.park.listSearch;
import com.plaxto.hino.mobile.park.searchDetail;
import com.plaxto.hino.mobile.park.listSearch.ShowDetail;
...
public class listSearch extends ListActivity {
	...
	private static String url_all_products = LoginActivity.IP_SERVER+"listSearch.php";
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(listSearch.this);
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < products.length(); i++) {
						...
						String waktuMasuk = c.getString("TimeIn");
						...
						map.put("durasi", c.getString("waktuDiff"));
						map.put("geoLocation1", c.getString("geoLocation1"));
						map.put("geoLocation2", c.getString("geoLocation2"));
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							listSearch.this, productsList,
							R.layout.list_item, new String[] { TAG_PID, "vin", 
									TAG_NAME,"brand","geoLocation1","geoLocation2","waktuMasuk","durasi"},
							new int[] { R.id.pid, R.id.VINNUMBEROK, R.id.name, R.id.brandnya, R.id.AreaParkirnyaGan , R.id.LongTxt , R.id.JamMasuknyaGan , R.id.DurasiParkir  }){
						@Override
				        public View getView (int position, View convertView, ViewGroup parent)
				        {
				            ...
				            vinkirim = ((TextView) v.findViewById(R.id.VINNUMBEROK)).getText()
		            				.toString();
...
//				               	 vinkirim = ((TextView) view.findViewById(R.id.VINNUMBEROK)).getText()
				    				//	.toString();   	
				                    Toast.makeText(listSearch.this,"save"+vinkirim,Toast.LENGTH_SHORT).show();
				                }
				            });
	...
	class showMap extends AsyncTask<String, String, String> {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					try {
						// Building Parameters
						List<NameValuePair> params = new ArrayList<NameValuePair>();
						params.add(new BasicNameValuePair("vin", vinkirim));
						params.add(new BasicNameValuePair("idParkir", LoginActivity.idParkirPetugas));
		...
		protected void onPostExecute(String file_url) {
			...
			Intent i = new Intent(listSearch.this, map_activity.class);

	...
	**/
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			...
			holder.caption = (EditText) view.findViewById(R.id.textRemark);
            view.setTag(holder);
		}else{
			 holder = (ViewHolder) view.getTag();
		}
		/**
		final EditText edittext = ((EditText) view.findViewById(R.id.txtRemark));
		...
		((TextView) view.findViewById(R.id.tvDescr)).setText(p.nameChild);
		((TextView) view.findViewById(R.id.tvPrice)).setText(p.nameMaster + "");
		((TextView) view.findViewById(R.id.txtId)).setText(p.idChildPdi);

...
import com.plaxto.hino.mobile.park.ItemPdi;
import com.plaxto.hino.mobile.park.ListAdapter;
import com.plaxto.hino.mobile.park.checkPDIOut;
...
import com.plaxto.hino.mobile.park.checkPDIOut.ShowDetail;
...
public class checkPDIOut extends ListActivity {
	...
	private static String url_all_listPDI = LoginActivity.IP_SERVER+"listOpsiPDIExit.php";
	private static String url_save_pdi = LoginActivity.IP_SERVER+"savePDIOut.php";
	...
	EditText txtKeterangan,txtRemark;
	...
	private void prepareKirim(){
		...
		for(String s:optionPDIList.get("option"+i)){
			...
			if(pecahOption[0].toString().equals("idPdi")){
				...
				remarknya = pecahOption[1].toString();
			}
		...
		if(kumpulanremark.toString().equals("")){
			kumpulanremark = remarknya; 
		}else{
			kumpulanremark = kumpulanremark+"-.-"+remarknya;
		}
		}
		**/
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(checkPDIOut.this);
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < products.length(); i++) {
						...
						optionPDIList.put("option"+i, new String[] {"idPdi,!,"+c.getString("idChildPdi"),"namaPdi,!,"+c.getString("namaChildPdi"),"userSelect,!,"+"Not Good","remark,!,"+c.getString("idChildPdi")+",None"});
						jumlahOption++;
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					 ...
					 * */
					boxAdapter = new ListAdapter(checkPDIOut.this, newPdi);
	...
	public void klikRadio(int posisiNavigasi,String userPilih,String remark){
		...
		optionPDIList.put("option"+posisiNavigasi, new String[] {"idPdi,!,"+idPdi,"namaPdi,!,"+namaPdi,"userSelect,!,"+userSelect,"remark,!,"+remarknya});
			...
			runOnUiThread(new Runnable() {
				public void run() {
					if(statusSimpan){
						...
						Toast.makeText(checkPDIOut.this, 
	...
	class showMap extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			Intent i = new Intent(checkPDIOut.this, map_activity2.class);
						startActivity(i);
			pDialog.dismiss();
	...
	public void onBackPressed() {
		Intent i = new Intent(checkPDIOut.this, listWaitingPdi.class);
		startActivity(i);
		finish();
	}
	
	private void dialogSuccess(){
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(checkPDIOut.this);
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int which) {
            // User pressed YES button. Write Logic Here
        	  	Intent i = new Intent(checkPDIOut.this, AndroidDashboardDesignActivity.class);
          		startActivity(i);
				finish();
            }
        });

...
public class checkPDIOut extends ListActivity
{
	...
	public void onCreate(Bundle icicle)
	{
		...
		text_view_note.setText(Html.fromHtml(getString(R.id.text_view_note)));
	...
	public void klikRadio(int posisiNavigasi, String userPilih, String remark)
	{
		...
		optionPDIList.put("option" + posisiNavigasi, new String[] { "idPdi,!," + idPdi, "namaPdi,!," + namaPdi,
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					...
					{
						Toast.makeText(checkPDIOut.this, "Failed to save the PDI Check. ", Toast.LENGTH_LONG).show();
					}
				}
			});

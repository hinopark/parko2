...
public class transferOut  extends ListActivity {
	
	
	private static final String URL_API_ = LoginActivity.IP_SERVER+"MainGateSave.php";
	private static final String URL_API_OUT = LoginActivity.IP_SERVER+"transferOut.php";
	...
	private static String url_all_products = LoginActivity.IP_SERVER+"transferOutHistory.php";
	...
	public void onBackPressed() {
		gpsMain.stopGps();
		Intent i = new Intent(transferOut.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}
	
	private void setupViews() {
		gpsMain 	= new  GpsMain(transferOut.this);
	...
	**/
	...
	public void parseJSON(JSONObject jsonResponse){
		try {
		    ...
		    if(success.toString().equals("1")){
	    		...
	    		AlertDialog.Builder alertDialog = new AlertDialog.Builder(transferOut.this);
        ...
        builder.setMessage("Do you want to log out or exit application ?")
               ...
               .setPositiveButton("Yes Logout", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                	   ...
                	   Intent i = new Intent(transferOut.this, LoginActivity.class);
							startActivity(i);
	...
	private void dialogRegister(){
		...
		LayoutInflater inflater = transferOut.this.getLayoutInflater();
	...
	class LoadHistory extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(transferOut.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(transferOut.this,

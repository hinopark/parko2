...
public class map_activity extends Activity  implements LocationListener, android.location.LocationListener, SensorEventListener{
	GoogleMap map;
	Circle MyCircle;
	...
	Marker youarehere;
	 ...
	 static  LatLng POSISI_AREA = new LatLng(listSearch.Clatitude,listSearch.Clongitude);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slatitude = listSearch.Slatitude;
        slongitude = listSearch.Slongitude;
     ...
     //map.getMapCenter();   
        ...
        Marker mobilnya = map.addMarker(new MarkerOptions().position(POSISI_MOBIL).title("Vin Number : "+listSearch.vinNya));
        mobilnya.showInfoWindow();
        mobilnya.setPosition(POSISI_MOBIL);
        
        CircleOptions circleOptions = new CircleOptions()
        .center(POSISI_MOBIL)   //set center
        .radius(listSearch.maccuracy)   //set radius in meters
        .fillColor(0x40ff0000)  //semi-transparent
        .strokeColor(Color.BLUE)
        .strokeWidth(5);
        Polygon polygon = map.addPolygon(new PolygonOptions()
        .add(new LatLng(listSearch.lat1, listSearch.long1), new LatLng(listSearch.lat2, listSearch.long2), new LatLng(listSearch.lat3, listSearch.long3), new LatLng(listSearch.lat4, listSearch.long4))

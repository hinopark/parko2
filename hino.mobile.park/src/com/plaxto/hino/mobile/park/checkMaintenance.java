...
public class checkMaintenance extends ListActivity
{
...
//	private EditText txtRemark;
	...
	class LoadAllProducts extends AsyncTask<String, String, String>
	{
		...
		protected void onPreExecute()
		{
			...
			pDialog.setMessage("Loading list maintenance item. Please wait...");
			...
			try
			{
				...
				if (success == 1)
				{
					...
					for (int i = 0; i < products.length(); i++)
					{
						...
						String namaChildPdi = c.getString("namaChildMaintenance");

						// creating new HashMap
						HashMap<String, String> map = new HashMap<String, String>();

						// adding each child node to HashMap key => value
						newPdi.add(new ItemPdi(c.getString("namaChildMaintenance"), c.getString(TAG_NAME),
								R.drawable.ic_launcher, c.getString("idChildMaintenance"), true));
						map.put(TAG_NAME, name);
						map.put("namaChildPdi", namaChildPdi);
						optionPDIList.put("option" + i, new String[] { "idPdi,!," + c.getString("idChildMaintenance"),
								"namaPdi,!," + c.getString("namaChildMaintenance"), "userSelect,!," + "Not Good",
								"remark,!," + c.getString("idChildMaintenance") + ",None" });
						jumlahOption++;
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					...
					if (lanjutkan)
					{
						boxAdapter = new ListAdapter(checkMaintenance.this, newPdi);
	...
	class simpanPDI extends AsyncTask<String, String, String>
	{
		...
		protected void onPreExecute()
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(checkMaintenance.this);
			pDialog.setMessage("Saving Maintenance Checking. Please wait...");
			pDialog.setIndeterminate(false);
			pDialog.setCancelable(false);
			pDialog.show();
		}
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					...
					{
						Toast.makeText(checkMaintenance.this, "Failed to save the PDI Check. ", Toast.LENGTH_LONG).show();
					}
				}
			});
	...
	class showMap extends AsyncTask<String, String, String>
	{
		...
		protected void onPostExecute(String file_url)
		{
			...
			Intent i = new Intent(checkMaintenance.this, map_activity2.class);
			startActivity(i);
			pDialog.dismiss();

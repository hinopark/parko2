...
public class ListWaitingMaintanance extends ListActivity
{
	...
	class LoadAllProducts extends AsyncTask<String, String, String>
	{
		...
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(ListWaitingMaintanance.this);
						...
						public View getView(int position, View convertView, ViewGroup parent)
						{
							...
							b.setOnClickListener(new OnClickListener()
							{
								...
								public void onClick(View arg0)
								{
									...
									Intent i = new Intent(ListWaitingMaintanance.this, checkPDI.class);
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					...
					{
						AlertDialog.Builder alertDialog = new AlertDialog.Builder(ListWaitingMaintanance.this);
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					 ...
					 * Updating parsed JSON data into ListView
					 * */
					ListAdapter adapter = new SimpleAdapter(ListWaitingMaintanance.this, productsList, R.layout.list_item,
						...
						public View getView(int position, View convertView, ViewGroup parent)
						{
							...
							b.setOnClickListener(new OnClickListener()
							{
								...
								public void onClick(View arg0)
								{
									...
									// view.findViewById(R.id.VINNUMBEROK)).getText()
									// .toString();
									Toast.makeText(ListWaitingMaintanance.this, "save" + vinkirim, Toast.LENGTH_SHORT).show();
								}
							});
	...
	class showMap extends AsyncTask<String, String, String>
	{
		...
		protected void onPostExecute(String file_url)
		{
			...
			Intent i = new Intent(ListWaitingMaintanance.this, map_activity2.class);
			startActivity(i);
			pDialog.dismiss();
	...
	{
		Intent i = new Intent(ListWaitingMaintanance.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}

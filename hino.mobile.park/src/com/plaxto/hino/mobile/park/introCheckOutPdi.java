...
public class introCheckOutPdi  extends ListActivity {
	
	
	private static final String URL_API_ = LoginActivity.IP_SERVER+"MainGateSave.php";
	private static final String URL_CHECK = LoginActivity.IP_SERVER+"checkBeforeSoldPDI.php";
	...
	private String idMobil,vinKirim;
	View view2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getActionBar().setTitle("PDI on Exit : "+ LoginActivity.namaParkirArea);
	...
	public void onBackPressed() {
		gpsMain.stopGps();
		//showLogOut();
		Intent i = new Intent(introCheckOutPdi.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}
	
	private void setupViews() {
		gpsMain 	= new  GpsMain(introCheckOutPdi.this);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
	    ...
	    case R.id.action_settings:
	    	  AlertDialog.Builder alert = new AlertDialog.Builder(introCheckOutPdi.this);

        	  alert.setTitle("Konfirmasi Password");
        	  alert.setMessage("Masukkan Password Anda");

        	  // Set an EditText view to get user input 
        	  final EditText input = new EditText(introCheckOutPdi.this);
        	  ...
        	  public void onClick(DialogInterface dialog, int whichButton) {
        	    ...
        	    if(kiko.toString().equals("1234")){
        	    	Intent i = new Intent(introCheckOutPdi.this, FormSetting.class);
        	    	startActivity(i);
        	    	finish();
        	    }else{
        	    	Toast.makeText(introCheckOutPdi.this, 
	    ...
	    case R.id.action_search:
	    	Intent b = new Intent(introCheckOutPdi.this, FormSearchActivity.class);
			startActivity(b);
	    	//initialize();
	    ...
	    case R.id.action_listParkir:
	    	Intent c = new Intent(introCheckOutPdi.this, listParking.class);
			startActivity(c);
			finish();
	    	//initialize();
	    	//initializeServer(null, null, 0.0, 0.0);
		...
		try {
		    ...
		    if(res.toString().equals("001")){
		    	if(statusPesan.toString().equals("002")){
		    		dialog.dismiss();
		    		AlertDialog.Builder alertDialog = new AlertDialog.Builder(introCheckOutPdi.this);
...
//                });
  ...
  //              alertDialog.show();
        ...
        builder.setMessage("Do you want to log out or exit application ?")
               ...
               .setPositiveButton("Yes Logout", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                	   ...
                	   Intent i = new Intent(introCheckOutPdi.this, LoginActivity.class);
							startActivity(i);
	...
	private void dialogRegister(){
		...
		LayoutInflater inflater = introCheckOutPdi.this.getLayoutInflater();
	...
	class LoadHistory extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(introCheckOutPdi.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							introCheckOutPdi.this, productsList,
	...
	class checkAllowPDI extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			params2.add(new BasicNameValuePair("idparkir", LoginActivity.idParkirPetugas));
			// getting JSON string from URL
			JSONObject json2 = jParser.makeHttpRequest(URL_CHECK, "GET", params2);
			...
			try {
				// Checking for SUCCESS TAG
				String success = json2.getString("adaMobil");

				if (success.toString().equals("Ya")) {
					int allow = json2.getInt("allow");
					if(allow == 0){
						allowOutPdi = false;
					}else{
						allowOutPdi = true;
						idMobil = json2.getString("idMobil");
						vinKirim = txtResultQR.getText().toString();
					}
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					if(allowOutPdi){
						Intent i = new Intent(introCheckOutPdi.this, checkPDIOut.class);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(introCheckOutPdi.this,

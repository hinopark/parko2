...
public class ActivityStartMaintenance extends ListActivity
{
	...
	private static String url_listPDI_search = LoginActivity.IP_SERVER + "saveMaintenanceStart.php";
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        btnCari.setText("Start Maintenance");
	...
	class LoadAllProducts extends AsyncTask<String, String, String>
	{
		...
		{
			super.onPreExecute();
			pDialog = new ProgressDialog(ActivityStartMaintenance.this);
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					 ...
					 * */
					ListAdapter adapter = new SimpleAdapter(ActivityStartMaintenance.this, productsList,
						...
						public View getView(int position, View convertView, ViewGroup parent)
						{
							...
							b.setOnClickListener(new OnClickListener()
							{
								...
								public void onClick(View arg0)
								{
									...
									// vinPilih =
									// vinIndex.get(position2).toString();
									ListView lv = getListView();
									...
									// arg0.findViewById(R.id.VINNUMBEROK);
									...
									Intent i = new Intent(ActivityStartMaintenance.this, checkMaintenance.class);
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
							...
							public View getView(int position, View convertView, ViewGroup parent)
							{
								...
								b.setOnClickListener(new OnClickListener()
								{
									...
									public void onClick(View arg0)
									{
										...
										Intent i = new Intent(ActivityStartMaintenance.this, checkPDI.class);
										i.putExtra("idMobil", idMobil);
										i.putExtra("vinNumber", vinkirim);
										startActivity(i);
					...
					{
						AlertDialog.Builder alertDialog = new AlertDialog.Builder(ActivityStartMaintenance.this);
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					...
					if (hasilPencarian)
					{
						...
						// Setting Dialog Message
						alertDialog.setMessage("Sukses start maintenance");
		...
		protected void onPostExecute(String file_url)
		{
			...
			runOnUiThread(new Runnable()
			{
				public void run()
				{
					 ...
					 * Updating parsed JSON data into ListView
					 * */
					ListAdapter adapter = new SimpleAdapter(ActivityStartMaintenance.this, productsList, R.layout.list_item,
						...
						public View getView(int position, View convertView, ViewGroup parent)
						{
							...
							b.setOnClickListener(new OnClickListener()
							{
								...
								public void onClick(View arg0)
								{
									...
									// view.findViewById(R.id.VINNUMBEROK)).getText()
									// .toString();
									Toast.makeText(ActivityStartMaintenance.this, "save" + vinkirim, Toast.LENGTH_SHORT).show();
								}
							});
	...
	class showMap extends AsyncTask<String, String, String>
	{
		...
		protected void onPostExecute(String file_url)
		{
			...
			Intent i = new Intent(ActivityStartMaintenance.this, map_activity2.class);
			startActivity(i);
			pDialog.dismiss();
	...
	{
		Intent i = new Intent(ActivityStartMaintenance.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}

...
import com.plaxto.hino.mobile.park.listStockEvent;
import com.plaxto.hino.mobile.park.searchDetail;

import com.plaxto.hino.mobile.park.listStockEvent.ShowDetail;
...
public class listStockEvent extends ListActivity {
	...
	private static String url_all_listPDI = LoginActivity.IP_SERVER+"listStockEvent.php";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.list_stock_event_intro);
        Intent i = getIntent();
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(listStockEvent.this);
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < products.length(); i++) {
						...
						String id = c.getString("idEvent");
						String name = c.getString("stockEventName");
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							listStockEvent.this, productsList,
							R.layout.list_stock_event, new String[] { TAG_PID, 
									TAG_NAME,"start","end"},
							new int[] { R.id.pid, R.id.name, R.id.startTime, R.id.endTime }){
						@Override
				        public View getView (int position, View convertView, ViewGroup parent)
				        {
				            ...
				            //View parentView = (View) convertView.getParent();
				             ...
				             Button b=(Button)v.findViewById(R.id.btnStockEvent);
				             b.setTag(position);
				             b.setOnClickListener(new OnClickListener() {
				                ...
				                public void onClick(View arg0) {
				                	...
				                	idEvent = indexMobil.get(position2).toString();
				                	nameEvent = vinIndex.get(position2).toString();
				                	...
				                	Intent i = new Intent(listStockEvent.this, MainStockControl.class);
				    				i.putExtra("idEvent", idEvent);
				    				i.putExtra("nameEvent", nameEvent);
				                	startActivity(i);
...
//				               	 vinkirim = ((TextView) view.findViewById(R.id.VINNUMBEROK)).getText()
				    				//	.toString();   	
				                    Toast.makeText(listStockEvent.this,"save"+vinkirim,Toast.LENGTH_SHORT).show();
				                }
				            });
	...
	class showMap extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			Intent i = new Intent(listStockEvent.this, map_activity2.class);
						startActivity(i);
			pDialog.dismiss();
	...
	public void onBackPressed() {
		Intent i = new Intent(listStockEvent.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}

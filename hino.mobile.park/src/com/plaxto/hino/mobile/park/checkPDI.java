...
import com.plaxto.hino.mobile.park.checkPDI;
...
import com.plaxto.hino.mobile.park.checkPDI.ShowDetail;
...
public class checkPDI extends ListActivity {
	...
	private void dialogEmpty(){
        ...
        builder.setMessage("Tidak ada mobil yang siap untuk Check PDI Entry ")
               .setCancelable(false)

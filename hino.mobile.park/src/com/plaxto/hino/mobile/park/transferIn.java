...
public class transferIn  extends ListActivity {
	
	
	private static final String URL_API_ = LoginActivity.IP_SERVER+"MainGateSave.php";
	private static final String URL_API_OUT = LoginActivity.IP_SERVER+"transferIn.php";
	...
	private static String url_all_products = LoginActivity.IP_SERVER+"transferInHistory.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.out_office);
		
		setupViews();
		productsList = new ArrayList<HashMap<String, String>>();
		getActionBar().setTitle("Tranporter Entry ");
	...
	public void onBackPressed() {
		gpsMain.stopGps();
		Intent i = new Intent(transferIn.this, AndroidDashboardDesignActivity.class);
		startActivity(i);
		finish();
	}
	
	private void setupViews() {
		gpsMain 	= new  GpsMain(transferIn.this);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
	    ...
	    case R.id.action_settings:
	    	  AlertDialog.Builder alert = new AlertDialog.Builder(transferIn.this);

        	  alert.setTitle("Konfirmasi Password");
        	  alert.setMessage("Masukkan Password Anda");

        	  // Set an EditText view to get user input 
        	  final EditText input = new EditText(transferIn.this);
        	  ...
        	  public void onClick(DialogInterface dialog, int whichButton) {
        	    ...
        	    if(kiko.toString().equals("1234")){
        	    	Intent i = new Intent(transferIn.this, FormSetting.class);
        	    	startActivity(i);
        	    	finish();
        	    }else{
        	    	Toast.makeText(transferIn.this, 
	    ...
	    case R.id.action_search:
	    	Intent b = new Intent(transferIn.this, FormSearchActivity.class);
			startActivity(b);
	    	//initialize();
	    	//initializeServer(null, null, 0.0, 0.0);
	    ...
	    case R.id.action_listParkir:
	    	Intent c = new Intent(transferIn.this, listParking.class);
			startActivity(c);
			finish();
	    	//initialize();
	    	//initializeServer(null, null, 0.0, 0.0);
	...
	**/
	...
	private void initializeServer(String qrCode, String date, double latitude, double longitude){
		if(isOnline() ==  true){
			...
			httpSync.execute(URL_API_OUT, params);
	...
	public void parseJSON(JSONObject jsonResponse){
		try {
		    ...
		    if(success.toString().equals("1")){
	    		...
	    		AlertDialog.Builder alertDialog = new AlertDialog.Builder(transferIn.this);
		    	 
                // Setting Dialog Title
                alertDialog.setTitle("Info :: ");
 
                // Setting Dialog Message
                alertDialog.setMessage("Vin Number ini tidak ada di daftar transfer");
                ...
                // Setting Dialog Message
                alertDialog.setMessage("Tidak dapat menerima mobil di Area Parkir ini ");
        ...
        builder.setMessage("Do you want to log out or exit application ?")
               ...
               .setPositiveButton("Yes Logout", new DialogInterface.OnClickListener() {
                   public void onClick(DialogInterface dialog, int id) {
                	   ...
                	   Intent i = new Intent(transferIn.this, LoginActivity.class);
							startActivity(i);
	...
	private void dialogRegister(){
		...
		LayoutInflater inflater = transferIn.this.getLayoutInflater();
	...
	class LoadHistory extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(transferIn.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(transferIn.this,

...
import com.plaxto.hino.mobile.park.listParking;
import com.plaxto.hino.mobile.park.searchDetail;

import com.plaxto.hino.mobile.park.listParking.ShowDetail;
...
public class listParking extends ListActivity {
	...
	class LoadAllProducts extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(listParking.this);
			...
			try {
				...
				if (success == 1) {
					...
					for (int i = 0; i < products.length(); i++) {
                       ...
                       vinIndex.add(c.getString("vinNumber"));
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							listParking.this, productsList,
							R.layout.list_parkir, new String[] { TAG_PID, "vin", 
									TAG_NAME,"brand","waktuMasuk","durasi"},
							new int[] { R.id.pid, R.id.VINNUMBEROK, R.id.name, R.id.brandnya, R.id.JamMasuknyaGan , R.id.DurasiParkir  }){
						@Override
...
//				               	 vinkirim = ((TextView) view.findViewById(R.id.VINNUMBEROK)).getText()
				    				//	.toString();   	
				                    Toast.makeText(listParking.this,"save"+vinkirim,Toast.LENGTH_SHORT).show();
				                }
				            });
	...
	class showMap extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String file_url) {
			...
			Intent i = new Intent(listParking.this, map_activity2.class);
						startActivity(i);
			pDialog.dismiss();
	...
	public void onBackPressed() {
		Intent i = new Intent(listParking.this, MainActivity.class);
		startActivity(i);
		finish();
	}
